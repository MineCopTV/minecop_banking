...
function payOpenGeneral(){
    $('body').addClass('active');
    $('#mainPayPage, #pay, #mainDebitCards').show();
}
...
function payOpen(payId){
    $('.pay-page').hide();
    $(payId).show();
}

function payKeyAction(action){
    $('.pay-btn').data("action", action);
}
...
function updateValues(){
    ...
    $('#bankDashboardName').val("Dane: " + currentAccount.name);
    $('#bankDashboardAccountNumber').val("Numer: " + currentAccount.number);
    $('#bankSettingsName').val("Dane: " + currentAccount.name);
    $('#bankSettingsAccountNumber').val("Numer: " + currentAccount.number);
    ...
    if(currentAccount.card !== undefined){
        ...
        $('#bankSettingsCardNumber').val("Numer: " + currentAccount.card.number);
        $('#bankSettingsCardPIN').val("PIN: " + currentAccount.card.pin);
        $('#bankSettingsCardCardNumber').val("Numer: " + currentAccount.card.number);
        ...
        $('#bankSettingsCardNumber').val("Tutaj jest miejsce na numer karty");
        $('#bankSettingsCardPIN').val("Tutaj jest miejsce na PIN karty");
        $('#bankSettingsCardCardNumber').val("Tutaj jest miejsce na numer karty");
        $('#bankSettingsCardCardPIN').val("Tutaj jest miejsce na PIN karty");
        $('#bankSettingsCardNewCardPIN').attr("placeholder", "Tutaj jest miejsce na PIN");
        $('#bankSettingsCardPaypass').val(0);
        $('#bankSettingsCardPaypassLimit').attr("placeholder", "Tutaj jest miejsce na limit PayPass");
    }

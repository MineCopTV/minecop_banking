...
-- Blips for Bank's and ATM's
Config.Blips = {
    ATM = {
        byProps = true,
        props = {"prop_atm_02", "prop_atm_03", "prop_fleeca_atm"},
        blip = true,
        blipSprite = 277,
        blipScale = 0.6,
        blipColour = 43,
        positions = {
            ...
            {x = 2683.006, y = 3286.578, z = 54.35},
            {x = 1171.981, y = 2702.681, z = 37.27},
            {x = -3040.736, y = 593.140, z = 7.01},
            {x = 316.08, y = -587.25, z = 43.29},
            {x = -30.272, y = -723.757, z = 43.35},
            {x = -28.052, y = -724.601, z = 43.35},
            {x = -815.75, y = -1040.76, z = 26.75},
            {x = -1390.66, y = -590.32, z = 29.5},
            {x = 815.77, y = -1040.77, z = 26.0},
            {x = 106.95, y = -738.93, z = 45.75}
        }
    },
    Bank = {
        blip = true,
        ...
        positions = {
            ...
            {x = 1175.063, y = 2706.640, z = 38.094}
        }
    }
}